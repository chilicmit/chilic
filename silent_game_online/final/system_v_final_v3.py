...
try:
    ...
    f.writelines("09/25/2022, 13:27:04:   #8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,1#")
    f.writelines("09/25/2022, 13:27:04:   Original")
    f.close()
        ...
        if len(data.split(",")) < 10:
            ...
            for i in msgg.split(",")[:-1]:
                ...
                if j < 0:
                    ...
                    j = 70
                temp_msgg.append(str(j))
            d = msgg.split(",")[-1]
            temp_msgg.append(d)
            msgg = temp_msgg

            msgg = ",".join(newbuilding)  # reconstruct msgg as string
